...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    window.location.href="tpo_login.php";
    </script>';
...
<div class="row">
  ...
  <div class="jumbotron jumbotron-special text-left col-md-6">
    ...
    <div class="jumbotron text-center col-md-6">
      ...
      <input type="text" padding-left="10px" width = "70%" id = "id" name="id" class="form-control" size="50" placeholder="id" required><br>
