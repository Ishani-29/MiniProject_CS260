...
<div class="jumbotron text-center">
    ...
    <form method = "post" novalidate >
        ...
        <input type ="batch_year"  id="batch_year" name = "batch_year" value=""><button class="button">SHOW TRENDS</button>
        </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        $mysqli = require __DIR__ . "/connection.php";
        $y=$_POST["batch_year"];
        $sql6 = "SELECT salary as max_offer from student where batch_year=\"{$y}\" order by salary desc limit 3";
        
        $result = $mysqli->query($sql6);
        ?>
        <div class="container">
<div class="jumbotron text-center">
        <h3>Maximum salaries offered during the year:</h3>
        <ol>
        <?php
...
?>
    ...
    <div id="c_place" style="width: 800px; height: 400px; margin-left: 350px"></div>
      <br>
    <div id="p_place" style="width: 800px; height: 400px; margin-left: 350px"></div>
        <br>
    ...
    <br>
    <div id="b_max" style="width: 1500px; height: 600px; margin-left: 400px"></div>
